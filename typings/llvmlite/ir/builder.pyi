...
class IRBuilder:
    ...
    def position_at_start(self, block: ir.Block) -> None:
        """
        Position at the start of the basic *block*.
        """
        ...
    
    def position_at_end(self, block: ir.Block) -> None:
        """
    ...
    def add(self, lhs: ir.Value, rhs: ir.Value, name=...) -> instructions.Instruction:
        """
        Integer addition:
            name = lhs + rhs
        """
    ...
    def fadd(self, lhs: ir.Value, rhs: ir.Value, name=...) -> instructions.Instruction:
        """
    ...
    def sub(self, lhs: ir.Value, rhs: ir.Value, name=...) -> instructions.Instruction:
        """
        Integer subtraction:
            name = lhs - rhs
        """
    ...
    def fsub(self, lhs: ir.Value, rhs: ir.Value, name=...) -> instructions.Instruction:
        """
    ...
    def mul(self, lhs: ir.Value, rhs: ir.Value, name=...) -> instructions.Instruction:
        """
    ...
    @_binop('fmul')
    def fmul(self, lhs: ir.Value, rhs: ir.Value, name=...) -> instructions.Instruction:
        """
    ...
    def sdiv(self, lhs: ir.Value, rhs: ir.Value, name=...) -> instructions.Instruction:
        """
    ...
    def fdiv(self, lhs: ir.Value, rhs: ir.Value, name=...) -> instructions.Instruction:
        """
    ...
    def srem(self, lhs: ir.Value, rhs: ir.Value, name=...) -> instructions.Instruction:
        """
    ...
    def frem(self, lhs: ir.Value, rhs: ir.Value, name=...) -> instructions.Instruction:
        """
    ...
    def icmp_signed(self, cmpop: str, lhs: ir.Value, rhs: ir.Value, name=...) -> instructions.ICMPInstr:
        """
    ...
    def fcmp_ordered(self, cmpop: str, lhs: ir.Value, rhs: ir.Value, name=..., flags=...) -> instructions.FCMPInstr:
        """
    ...
    @_castop('bitcast')
    def bitcast(self, value: ir.Value, typ: ir.Type, name=...) -> ir.Value | instructions.CastInstr:
        """
    ...
    def alloca(self, typ: ir.Type, size=..., name=...) -> ir.AllocaInstr: # -> AllocaInstr:
        """
    ...
    def load(self, ptr: ir.Value, name=..., align=..., typ=...) -> instructions.LoadInstr:
        """
    ...
    def store(self, value: ir.Value, ptr: ir.Value, align=...) -> ir.StoreInstr: # -> StoreInstr:
        """
    ...
    def switch(self, value: ir.Value, default: ir.Block) -> ir.SwitchInstr:
        """
        Create a switch-case with a single *default* target.
        """
        ...
    
    def branch(self, target: ir.Block) -> ir.Branch:
        """
        Unconditional branch to *target*.
        """
        ...
    
    def cbranch(self, cond: ir.Value, truebr: ir.Block, falsebr: ir.Block) -> ir.ConditionalBranch:
        """
    ...
    def ret(self, value: ir.Value) -> ir.Ret: # -> Ret:
        """
    ...
    def call(self, fn: ir.Value, args: list[ir.Value], name=..., cconv=..., tail=..., fastmath=..., attrs=..., arg_attrs=...) -> instructions.CallInstr:
        """
    ...
    def gep(self, ptr: ir.Value, indices: list[Any], inbounds=..., name=..., source_etype=...) -> instructions.GEPInstr:
        """
    ...
    def phi(self, typ: ir.Type, name=..., flags=...) -> instructions.PhiInstr:
        ...
